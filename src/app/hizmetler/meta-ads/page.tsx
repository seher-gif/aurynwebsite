            ...
            <main className="isolate">
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="mx-auto max-w-2xl text-center">
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-600 font-body">
                                    Sosyal medya reklamlarıyla potansiyel müşterilerinize ulaşın. Hedefleme ve retargeting stratejileriyle satışlarınızı artırın.
                                </p>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 text-center mb-12">
                        Meta Ads Hizmetlerimiz
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            "Facebook Reklam Kampanyaları",
                            "Instagram Reklam Kampanyaları",
                            "Carousel ve Story Reklamları",
