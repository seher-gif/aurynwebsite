...
export const metadata: Metadata = pageMetadata({
    ...
    path: "/en/contact",
    title: "Contact Us",
    description: "Get in touch with Auryn Dijital for your SEO, Google Ads, and digital marketing projects. Reach our team in Antalya, Turkey.",
});
                ...
                <div className="relative isolate px-6 py-24 sm:py-32 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl text-center relative z-10">
                        <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl font-heading">
                            Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-auryn-magenta to-auryn-purple">Touch</span>
                        </h1>
                        <p className="mt-2 text-lg leading-8 text-gray-400">
                            Reach out to discuss your project or request a proposal.
                        </p>
                    </div>
                        ...
                        <div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+905319409065" className="text-gray-400 hover:text-auryn-magenta transition-colors">+90 531 940 90 65</a>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-400">Üçgen, Abdi İpekçi Cd. no:13 kat:1, 07040 Muratpaşa/Antalya, Turkey</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="w-full rounded-2xl overflow-hidden shadow-2xl shadow-auryn-magenta/10 border border-white/10 grayscale hover:grayscale-0 transition-all duration-500">
                                <iframe
                                    ...
                                    title="Auryn Dijital Office Location"
                                />
                            </div>
                        </div>
