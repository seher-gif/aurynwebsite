...
export default function GoogleAdsYonetimiPage() {
    return (
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="mx-auto max-w-2xl text-center">
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-300 font-body">
                                    Hedef kitlenize en doğru zamanda ulaşarak dönüşümlerinizi maksimize edin. Arama, Görüntülü Reklam ve Alışveriş kampanyalarıyla ROI odaklı çalışıyoruz.
                                </p>
