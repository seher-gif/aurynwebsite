...
export const metadata: Metadata = pageMetadata({
    ...
    path: "/en/services",
    title: "Our Services",
    description: "SEO, Google Ads, Meta Ads, social media management, content marketing, and analytics & reporting. Explore Auryn Dijital's data-driven digital marketing services.",
});

const services = [
    {
        name: "SEO",
        description: "Climb search rankings and grow organic traffic that compounds. Technical SEO, content optimization, and link strategy focused on durable visibility.",
        icon: Search,
        href: "/en/services/seo",
    },
    {
        name: "Google Ads Management",
        description: "Reach the right audience at the right moment and maximize conversions. Search, Display and Shopping campaigns run with ROI as the north star.",
        icon: TrendingUp,
        href: "/en/services/google-ads",
    },
    {
        name: "Social Media Management",
        description: "Build brand awareness and engage your community. Creative strategy across Instagram, LinkedIn, X and TikTok.",
        icon: Globe,
        href: "/en/services/social-media",
    },
    {
        name: "Content Marketing",
        description: "Win attention with content that's actually worth reading. Blog articles, guides and video content that build your brand's authority.",
        icon: PenTool,
        href: "/en/services/content-marketing",
    },
    {
        name: "Meta Ads (Facebook & Instagram)",
        description: "Reach prospective customers through social advertising. Targeting and retargeting strategies built to drive sales.",
        icon: Megaphone,
        href: "/en/services/meta-ads",
    },
    {
        name: "Analytics & Reporting",
        description: "Track performance with transparent, detailed reporting. Make decisions from data and keep refining the strategy.",
        icon: BarChart2,
        href: "/en/services/analytics-reporting",
    },
];
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="mx-auto max-w-3xl text-center">
                                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl font-heading mb-6">
                                    Our Digital <span className="text-transparent bg-clip-text bg-gradient-to-r from-auryn-magenta to-auryn-purple">Services</span>
                                </h1>
                                <p className="mt-6 text-lg leading-8 text-gray-400 font-body max-w-2xl mx-auto">
                                    Everything your brand needs in digital marketing, in one place. Data-driven, transparent, and built to deliver results.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-400">
                                Run our free analysis to see exactly what your site needs, and get a roadmap built around it.
                            </p>
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                <Button size="lg" className="bg-gradient-to-r from-auryn-magenta to-auryn-purple hover:opacity-90 text-white border-0 h-12 px-8 text-base rounded-xl transition-transform hover:scale-105" asChild>
                                    <Link href="/en/seo-analysis">Run Free Analysis</Link>
                                </Button>
