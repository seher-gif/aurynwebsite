...
const STRINGS = {
    tr: {
        ...
        heroTitleHighlight: "Ücretsiz",
        heroTitleSuffix: "Öğrenin",
        heroSubtitle: "Google E-E-A-T standartlarına göre sitenizi analiz edin ve uzman önerileri alın.",
        placeholder: "Web sitenizin adresini girin (örn: auryn.com)",
        analyzeButton: "Ücretsiz Analiz Et",
        analyzing: "Analiz Ediliyor...",
        analyzingBody: "Lütfen bekleyin. Bu işlem 15-20 saniye sürebilir.",
        resultsHeading: "Analiz Sonuçları",
        pageSpeedHeading: "Google PageSpeed Skorları",
        performanceUnavailable: "Performans verisi bu analizde kullanılabilir değil.",
        analyzedLabel: "Analiz edilen:",
        overallScoreHeading: "Genel SEO Puanınız",
        screenshotsHeading: "Sayfa Görünümleri",
        opportunitiesHeading: "🚀 Gelişme Fırsatları",
        potentialSavings: "Potansiyel tasarruf",
        emailFormHeading: "Detaylı Raporu",
        emailFormHighlight: "E-posta Adresinize",
        emailFormHeadingSuffix: "Alın",
        emailFormBody: "Tüm iyileştirme önerilerini içeren detaylı raporu kaçırmayın.",
        emailPlaceholder: "E-posta adresinizi girin",
        sendReportButton: "Raporu Gönder",
        consentNote: "Formu göndermek pazarlama iletişimine izin vermiş olursunuz.",
        partnersHeading: "Partnerlerimiz",
        partnersBody: "Veri odaklı dijital performans ajansı. Markanızı dijital dünyada büyütüyoruz.",
        errorGeneric: "Analiz başarısız oldu. Lütfen tekrar deneyin.",
        reportSent: "Detaylı rapor email adresinize gönderildi!",
        reportFailed: "Rapor gönderilemedi. Lütfen tekrar deneyin.",
    },
    en: {
        heroTitlePrefix: "Find Out Your Website's SEO Score,",
        heroTitleHighlight: "Free",
        heroTitleSuffix: "",
        heroSubtitle: "Analyze your site against Google's E-E-A-T standards and get expert recommendations.",
        placeholder: "Enter your website address (e.g. auryn.com)",
        analyzeButton: "Run Free Analysis",
        analyzing: "Analyzing...",
        analyzingBody: "Please wait, this can take 15-20 seconds.",
        resultsHeading: "Analysis Results",
        pageSpeedHeading: "Google PageSpeed Scores",
        performanceUnavailable: "Performance data is not available for this analysis.",
        analyzedLabel: "Analyzed:",
        overallScoreHeading: "Your Overall SEO Score",
        screenshotsHeading: "Page Screenshots",
        opportunitiesHeading: "🚀 Improvement Opportunities",
        potentialSavings: "Potential savings",
        emailFormHeading: "Get the Detailed Report",
        emailFormHighlight: "In Your Inbox",
        emailFormHeadingSuffix: "",
        emailFormBody: "Don't miss the full report with every improvement recommendation.",
        emailPlaceholder: "Enter your email address",
        sendReportButton: "Send Report",
        consentNote: "By submitting this form, you agree to receive marketing communications.",
        partnersHeading: "Our Partners",
        partnersBody: "A data-driven digital performance agency. We grow your brand's digital presence.",
        errorGeneric: "Analysis failed. Please try again.",
        reportSent: "The detailed report has been sent to your email!",
        reportFailed: "Could not send the report. Please try again.",
    },
};

export function SeoAnalyzer({ locale = "tr" }: { locale?: Locale }) {
    ...
    async function handleAnalyze() {
        ...
        try {
            const response = await fetch('/api/seo/analyze', {
                ...
                body: JSON.stringify({ url: domain, locale }),
            });
            ...
            if (response.ok) {
                ...
                alert(errorData.error || t.errorGeneric);
            }
        } catch (error) {
            ...
            <div className="relative px-6 py-24 sm:py-32 lg:px-8 bg-gradient-to-br from-black via-gray-900 to-black">
                ...
                <div className="relative mx-auto max-w-4xl text-center">
                    <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl font-heading mb-6">
                        {t.heroTitlePrefix} <span className="text-transparent bg-clip-text bg-gradient-to-r from-auryn-magenta to-auryn-purple">{t.heroTitleHighlight}</span> {t.heroTitleSuffix}
                    </h1>
                    <p className="mt-6 text-lg leading-8 text-gray-300 max-w-2xl mx-auto">{t.heroSubtitle}</p>
                            ...
                            <div className="bg-gradient-to-r from-auryn-magenta/20 to-auryn-purple/20 border-2 border-auryn-magenta/40 rounded-2xl p-8 text-center">
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-300">{t.analyzingBody}</p>
                                    </div>
                                </div>
                            </div>
                        )}
            ...
            {analysis && (
                <div className="px-6 py-16 mx-auto max-w-7xl bg-black">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-white mb-3">{t.resultsHeading}</h2>
                        <div className="w-20 h-1 bg-gradient-to-r from-auryn-magenta to-auryn-purple mx-auto rounded-full"></div>
                    </div>

                    {/* Score Cards */}
                    <div className="max-w-5xl mx-auto mb-12">
                        <h3 className="text-2xl font-semibold text-white mb-6 text-center">{t.pageSpeedHeading}</h3>
                        {!analysis.performanceAvailable || !analysis.scores ? (
                            <p className="text-center text-slate-400 bg-gray-900/50 border border-gray-800 rounded-2xl py-8 px-6">
                                {t.performanceUnavailable}
                            </p>
                        ) : (
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                {[
                                    { label: "Performance", score: analysis.scores.performance, color: "#3b82f6" },
                                    { label: "Accessibility", score: analysis.scores.accessibility, color: "#10b981" },
                                    { label: "Best Practices", score: analysis.scores.bestPractices, color: "#f59e0b" },
                                    { label: "SEO", score: analysis.scores.seo, color: "#ef4444" },
                                ].map((item, index) => {
                        ...
                        <p className="text-slate-400 text-sm text-center mt-6">
                            {t.analyzedLabel} <strong className="text-white">{analysis.url || domain}</strong>
                        </p>
                    </div>
                    ...
                    <div className="max-w-3xl mx-auto bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 mb-12 border-2 border-auryn-magenta/20 shadow-2xl shadow-auryn-magenta/10">
                        <div className="text-center">
                            <h3 className="text-xl font-semibold text-white mb-8">{t.overallScoreHeading}</h3>
                            <div className="relative inline-block mb-8">
                                <svg className="w-56 h-56">
                                    ...
                                    <circle cx="112" cy="112" r="100" fill="none" stroke="#1f2937" strokeWidth="20" />
                                    <circle
                                        cx="112"
                                        cy="112"
                                        r="100"
                    ...
                    {analysis.screenshots && analysis.screenshots.length > 0 && (
                        <div className="max-w-6xl mx-auto mb-12">
                            <h3 className="text-2xl font-semibold text-white mb-6">{t.screenshotsHeading}</h3>
                    ...
                    {analysis.opportunities && analysis.opportunities.length > 0 && (
                        <div className="max-w-5xl mx-auto mb-12">
                            <h3 className="text-2xl font-semibold text-white mb-6">{t.opportunitiesHeading}</h3>
                            {(() => {
                                const categories = ["Performance", "Accessibility", "Best Practices", "SEO"];
                                return categories.map((category) => {
                                    const categoryOpps = analysis.opportunities.filter((opp) => opp.category === category);
                                        ...
                                        <div key={category} className="mb-8">
                                            ...
                                            <div className="space-y-3">
                                                {categoryOpps.slice(0, 10).map((opp, index) => (
                                                    <div key={index} className="bg-gray-900/50 border border-gray-800 rounded-xl p-5 hover:border-auryn-magenta/30 transition-colors">
                                                        <div className="flex items-start justify-between gap-4">
                                                            <div className="flex-1">
                                                                <h5 className="font-semibold text-white mb-2">{opp.title}</h5>
                                                                {opp.description && <p className="text-sm text-gray-400 leading-relaxed">{opp.description}</p>}
                                                            </div>
                                                            {opp.savings > 0 && (
                                                                <div className="flex-shrink-0 text-right">
                                                                    <div className="text-xs text-gray-500 mb-1">{t.potentialSavings}</div>
                                                                    <div className="text-lg font-bold text-auryn-magenta">~{Math.round(opp.savings)}ms</div>
                                                                </div>
                                                            )}
                                                        </div>
                                                    </div>
                                ...
                                <div className="bg-gradient-to-br from-auryn-magenta/10 via-black to-auryn-purple/10 rounded-3xl p-12 border-2 border-auryn-magenta/30">
                                    <div className="text-center mb-8">
                                        ...
                                        <h3 className="text-3xl font-bold text-white mb-4">
                                            {t.emailFormHeading} <span className="text-transparent bg-clip-text bg-gradient-to-r from-auryn-magenta to-auryn-purple">{t.emailFormHighlight}</span> {t.emailFormHeadingSuffix}
                                        </h3>
                                        <p className="text-gray-300 text-base">{t.emailFormBody}</p>
                                    </div>
                                    ...
                                    <p className="text-xs text-gray-500 text-center mt-6">{t.consentNote}</p>
                                </div>
