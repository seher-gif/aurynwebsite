...
const posts = [
    {
        ...
        excerpt: "Arama motoru optimizasyonunda başarılı olmak için dikkat etmeniz gereken temel faktörler ve 2024 trendleri.",
        date: "24 Kasım 2024",
        category: "SEO",
        imageUrl: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2426&q=80",
        slug: "seo-stratejinizi-guclendirecek-5-ipucu",
    },
    {
        id: 2,
        title: "Google Ads ile Dönüşüm Oranlarınızı Artırın",
        excerpt: "Reklam bütçenizi en verimli şekilde kullanarak satışlarınızı ve potansiyel müşteri sayınızı nasıl artırabilirsiniz?",
        date: "20 Kasım 2024",
        category: "Google Ads",
        imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80",
        slug: "google-ads-ile-donusum-oranlarinizi-artirin",
    },
    {
        id: 3,
        title: "İçerik Pazarlamasında Hikaye Anlatıcılığının Gücü",
        excerpt: "Markanızın hikayesini doğru anlatarak hedef kitlenizle nasıl duygusal bir bağ kurabilirsiniz?",
        date: "15 Kasım 2024",
        category: "İçerik Pazarlama",
        imageUrl: "https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2348&q=80",
        slug: "icerik-pazarlamasinda-hikaye-anlaticiliginin-gucu",
    },
];
